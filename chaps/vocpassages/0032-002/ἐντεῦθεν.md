# ἐντεῦθεν, *hence*  in Xenophon's Memorabilia
...
| relation | lemma1 | lemma2 | lemma3  |
| --- | --- | --- | ---  |
# Instances of ἐντεῦθεν in Xenophon's Memorabilia:
1 results
...
| --- | --- | --- | --- |
| ______ | [ἐντεῦθεν](https://atlas-test.fly.dev/morphology/lemmas/?lang=grc&q=ἐντεῦθεν) | d-------- | hence |

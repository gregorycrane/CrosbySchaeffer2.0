# σιγή, *silence*  in Xenophon's Memorabilia
##  σιγή most commonly depends on the following
| relation | lemma1 | lemma2 | lemma3  |
| --- | --- | --- | ---  |
| 1 ADVd | 1 βουλεύω to take counsel, deliberate, concert measures | 
## Words most commonly depending on σιγή
| relation | lemma1 | lemma2 | lemma3  |
| --- | --- | --- | ---  |
| 1 ATR | 1 [ὁ](https://github.com/gregorycrane/CrosbySchaeffer2.0/tree/main/chaps/vocpassages/σιγή-deps.md#-σιγή-ATR-ὁ) the | 
# Instances of σιγή in Xenophon's Memorabilia:
1 results
## 1. [1.1.19](https://beyond-translation.perseus.org/reader/urn:cts:greekLit:tlg0032.002.perseus-grc2:1.1.19?mode=syntax-trees) 52 ['8921147']

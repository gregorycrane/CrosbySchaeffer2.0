# ἄπειμι, *be absent*  in Xenophon's Memorabilia
...
| relation | lemma1 | lemma2 | lemma3  |
| --- | --- | --- | ---  |
| 1 AuxZ | 1 [καί](https://github.com/gregorycrane/CrosbySchaeffer2.0/tree/main/chaps/vocpassages/ἄπειμι-deps.md#-ἄπειμι-AuxZ-καί) and, also | 
# Instances of ἄπειμι in Xenophon's Memorabilia:
1 results
## 1. [3.9.11](https://beyond-translation.perseus.org/reader/urn:cts:greekLit:tlg0032.002.perseus-grc2:3.9.11?mode=syntax-trees) 1333 ['8946902']
...
| --- | --- | --- | --- |
| ______ | [ἄπειμι](https://atlas-test.fly.dev/morphology/lemmas/?lang=grc&q=ἄπειμι) | v-pppama- | be absent |
